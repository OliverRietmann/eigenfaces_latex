...
\input{skript/introduction}
\input{skript/database}
%\input{skript/eigenfaces}
\input{skript/vectormatrix}
\input{skript/facespace}
\input{skript/eigenfaces}
\input{skript/eigenbasis}
\input{skript/compression}
%\input{skript/binary}
\input{skript/recognition}
%\input{skript/principalcomponents}
\clearpage
%\setcounter{section}{0}
%\renewcommand*{\theHsection}{\the\value{section}}
\part{Didaktische Methoden}
\input{methods/introduction}
\input{methods/interleaved}
\input{methods/scaffolding}
\input{methods/lernziele}
\input{methods/group}
\input{methods/problembased}
\input{methods/knowledge}
\input{methods/holistic}
\clearpage
\nocite{*}
