...
\end{lstlisting}
	...
	\begin{minipage}{0.2\textwidth}\vspace{-1cm}
		\centering\includegraphics[width=0.6\textwidth]{images/meanface}
	\end{minipage}
\end{losung*}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=0.5\textwidth]{images/meandiff}
...
\end{figure}
\begin{aufgabe}
	Nennen Sie einen Unterschied und eine Gemeinsamtkeit der vereinfachten Darstellung in Abbildung~\ref{fig:meandiff} zu unserer tatsächlichen Situation mit Bildern von Gesichtern.
